...
<html>
<head>
<title>UTA MAC |Unassigned Mars </title>
...
<body>
	...
	<nav class="navbar navbar-default">
         ...
         <div class="container">
         <div class="jumbotron">
			<h1 align="center">List of Unassigned MAR's</h1>
		</div>
...
<input type="text" value='' disabled style="border:none;width:1000px;font-size:20px; color:red;" />
