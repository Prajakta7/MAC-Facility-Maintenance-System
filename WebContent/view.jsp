...
<div class="container">
<div class="jumbotron">
			<h2 align="center">Select from drop down to view details</h2>
</div>	
<center>

<form action="FacilityController?action=view" method="post" >
Repairer-ID : Repairer-Lastname
<select name="repairer">
    <c:forEach items="${listRepairer}" var="repairer">
        <option value="${repairer.utaID}" >${repairer.utaID} : ${repairer.lastName}</option>
