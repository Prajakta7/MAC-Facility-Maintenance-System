...
<nav class="navbar navbar-default">
	...
	<div class="container">
		<div class="jumbotron">
			<h1 align="center">Reserve your Repair!</h1>
		</div>
...
<table>
  <tr>
   <td>
    ...
    <tr>
    <td> Date: </td>
    <td> <input type="hidden" name="adate" value="${res.date}" /> </input><c:out value="${res.date}" /></td>
    </tr>

  <input type="hidden" name="ft" value="${res.facility_type}" />
